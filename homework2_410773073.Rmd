...
```{r ans32}
Pikachu_stats<-c(
  as.numeric(Pikachu[[4]]$atk),
  as.numeric(Pikachu[[4]]$def),
  as.numeric(Pikachu[[4]]$hp)
  )
 Pikachu_stats
```
...
Gamemaster[[1]][[731]]<-list(
  ...
  speciesName="Mimikyu",
  speciesId="mimikyu",
  baseStats=list(atk=112,def=96,hp=111),
  types=c("ghost","fairy"),
  fastMoves=Gamemaster[[1]][[46]]$fastMoves,
  chargedMoves=Gamemaster[[1]][[46]]$chargedMoves,
  legacyMoves=Gamemaster[[1]][[46]]$legacyMoves,
  defaultIVs=Gamemaster[[1]][[46]]$defaultIVs)
